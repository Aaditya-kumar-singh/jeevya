    ...
    <ScrollView className="flex-1 bg-background" contentContainerStyle={{ paddingBottom: 40 }} refreshControl={<RefreshControl refreshing={loading} onRefresh={() => void refresh()} />}>
      <View className="gap-4 px-5 pt-14">
        <View className="flex-row items-center gap-3">
          ...
          <View className="flex-1"><Text size="sm" className="text-muted-foreground">Jeevya</Text><Heading size="xl" className="mt-1">Life Intelligence</Heading><Text size="sm" className="mt-1 text-muted-foreground">Deterministic signals from your existing Jeevya data</Text></View>
