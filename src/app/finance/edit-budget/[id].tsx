...
export default function EditBudgetScreen() {
  ...
  const { budgets, categories, editBudget, loading } = useFinance();
  ...
  const isDuplicate = useMemo(() => {
    return budgets.some(
      (b) => b.id !== id && b.categoryId === categoryId && b.month === month,
    );
  ...
  async function handleSave() {
    ...
    try {
      ...
      Alert.alert('Error', e instanceof Error ? e.message : 'Failed to update budget');
    } finally {
      setSaving(false);
    }
  }
